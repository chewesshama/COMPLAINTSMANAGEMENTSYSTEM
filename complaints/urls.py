...
from .views import HomeView, UserRegistrationView, IndexView, UserLoginView, userProfileUpdateView, ProfileView, UserRegistrationDoneView, AllUserDisplayView, AllComplaintsDisplayView, DeleteUserView, PasswordChangeCustomView, PasswordChangeDoneView, add_complaint, UserComplaintsDisplayView, custom_404_view, custom_403_view, custom_500_view
...
urlpatterns = [
    ...
    path("user-complaints/", UserComplaintsDisplayView.as_view(), name="user_complaints_display"),
