...
from .views import HomeView, UserRegistrationView, IndexView, UserLoginView, userProfileUpdateView, ProfileView, UserRegistrationDoneView, AllUserDisplayView, AllComplaintsDisplayView, DeleteUserView, PasswordChangeCustomView, PasswordChangeDoneView, AddComplaintView
